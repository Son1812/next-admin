  ...
  return (
    ...
    >
      ...
      <span aria-hidden className="relative flex gap-2.5">
        {/* Indicator */}
        <span className="absolute size-[30px] rounded-full border border-gray-200 bg-white transition-all dark:translate-x-[40px] dark:border-none dark:bg-dark-2 dark:group-hover:bg-dark-3" />
